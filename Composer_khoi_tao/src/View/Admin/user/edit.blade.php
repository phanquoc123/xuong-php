...
@section('content')
    ...
    <form class="mt-2 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ url("admin/users/{$user['id']}/update") }}"
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <div class="flex">
                ...
                <input type="text" id="website-admin" name="name" value="{{ $user['name'] }}"
        ...
        <div class="flex item-center gap-4">
            ...
            <div class="flex items-center mb-4 gap-2">
                ...
                <input id="country-option-1" type="radio" name="type" @if ($user['type'] == 'admin') checked @endif
