...
@section('content')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select">
                                        @foreach ($categoryPluck as $id => $name)
                                            <option @if ($product['category_id'] == $id) selected 
                                            @endif value="{{ $id }}">
    ...
    <form class="mt-2 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
        action="{{ url("admin/products/{$product['id']}/update") }}" enctype="multipart/form-data" method="POST">
        {{-- Name product --}}
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <div class="relative">
                ...
                <input type="number" id="email-address-icon" name="price_regular" min="1"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="$" value="{{ $product['price_regular'] }}">
            </div>
        </div>
        {{-- Price Sale --}}
        <div class="relative z-0 w-full mb-5 group">
